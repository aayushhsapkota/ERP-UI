...
function ImportFile() {
  ...
  const handleFile = useCallback(async (e) => {
    ...
    json.forEach((item, index) => {
      ...
      if (!item.hasOwnProperty("primaryUnit")) {
        item.primaryUnit = ""; //default primary unit when importing
        item.secondaryUnit = "";
  ...
  return (
    <div>
      <div className="sm:mr-4 p-4 mt-4">
        <PageTitle title="Import File" />
      </div>
      <div className="flex sm:mx-6 mx-4">
        <Button
          size="sm"
      ...
      {isProductImported ? (
        <div className="flex flex-wrap bg-zinc-50 shadow-sm rounded-lg mx-3 md:mx-6 mt-6 pt-6 sm:pt-10 pb-10">
          <p className="w-full px-6 lg:px-12 mb-4 sm:mb-1 text-gray-700 text-base font-title text-justify">
