  ...
  return (
    <div>
      <div className="py-4 px-6 sm:pl-6 sm:pr-2 capitalize flex justify-between items-center">
        <PageTitle title={`${productDetails?.title || " Detail"}`} />
        <Menu
          menuButton={
            <MenuButton>
      ...
      <div className="flex flex-wrap mb-1">
          ...
          <div className="w-full mb-4 sm:mb-1">
            {productDetails === null ? (
              ...
              <div className="bg-white rounded-xl p-2">
                <div className="flex flex-wrap justify-between items-center p-2">
                  ...
                  <div className="flex-col">
                    ...
                    <div className={defaultTdContentSecond}>
                      ...
                      >
                        {quantity?.toFixed(1)} {primaryUnit}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <hr />
                <div className="flex flex-wrap pt-3 text-[12px] sm:text-[15px] text-green-700 items-center justify-center cursor-pointer">
        ...
        <div className="w-full lg:w-2/6 pl-4 pr-4 sm:pl-4 sm:pr-2">
          {(productDetails !== null || initLoading !== "loading") && (
            <div className="mb-4 sm:mb-2 flex">
              <Button
