...
function ExpenseFilter() {
  ...
  const openModal = useSelector(getExpenseDateFilterOpenSelector);
  ...
  const onSubmitHandler = useCallback(() => {
    ...
    dispatch(setExpenseFilterBy(filterData));
    dispatch(setExpenseSortBy(sortData));
    dispatch(setExpenseDate(dateData));
    dispatch(setExpenseDateFilterOpen(false));
