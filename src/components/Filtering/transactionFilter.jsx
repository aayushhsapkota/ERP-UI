          ...
          <div className=" p-4 flex justify-center items-center min-h-full">
            <div className="relative rounded-lg overflow-hidden shadow-xl transform transition-all flex flex-col w-full md:w-8/12 lg:w-6/12 xl:w-5/12">
              <div className="bg-gray-50 text-gray-900 text-[0.98rem] leading-6 px-4 pt-5 sm:pb-4 flex-1">
                ...
                <div className="flex flex-wrap justify-start items-center my-2 max-w-xl mx-auto">
                  <div className="flex flex-row justify-center items-center mt-2 mr-4">
                    <div className="text-[0.8rem] sm:text-sm sm:text-center mr-3">
                      {" "}
                      Start Date{" "}
                    </div>
                    <NepaliDatePicker
                  ...
                  <div className="flex flex-row justify-center items-center mt-2">
                    <div className=" text-[0.8rem] sm:text-sm mr-4 sm:mr-3 sm:text-center">
                      {" "}
                      End Date{" "}
                    </div>
                    <NepaliDatePicker
