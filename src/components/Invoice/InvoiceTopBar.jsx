  ...
  return (
    <div className="bg-white rounded-xl px-3 py-3">
      <div className="flex flex-col flex-wrap sm:flex-row justify-between">
        <div
          className={`w-full my-1 sm:my-1 md:my-0 px-1 flex flex-row ${
            viewMode ? `sm:w-1/2 ${merchant ? "md:w-1/2" : "md:w-1/3"}` : ""
          }`}
        >
            ...
            <Button
              ...
              onClick={() => {
                if (subTotal > 0) {
                  ...
                  toast.error("Please add product to invoice", {
          ...
          <>
            ...
            <div
              className={`w-full sm:w-1/2 ${
                merchant ? "md:w-1/2" : "md:w-1/3"
              } my-1 sm:my-1 md:my-0 px-1`}
            >
              <Button
                size="sm"
                block={1}
