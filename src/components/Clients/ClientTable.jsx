      ...
      <>
        {initLoading !== "loading" &&
          ...
          data?.map((client, index) => (
            <div
              className={
                `bg-white rounded-xl cursor-pointer hover:bg-[#fdfdfd] transition-all duration-200` +
                ...
                {!openModal && (
                  <div className="flex-col flex-1">
                    <div className={defaultTdContent}>
                      <span className="whitespace-nowrap text-ellipsis overflow-hidden pb-0.5 font-medium">
                        {client.name}
                      </span>
                    </div>
                    <div className={defaultTdContent}>
                  ...
                  {!openModal && (
                    <div className={defaultTdContentSecond}>
                      <span className="whitespace-nowrap text-ellipsis overflow-hidden text-[14px] sm:text-[15px] text-gray-600">
                        {client.totalAmountToPay < 0
                          ? `${merchant === true ? "To Receive" : "To Pay"}`
                          : client.totalAmountToPay > 0
                          ? `${merchant === true ? "To Pay" : "To Receive"}`
                          : "Settled"}
                      </span>
                    </div>
                  )}
