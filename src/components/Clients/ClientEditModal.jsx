...
function ClientEditModal() {
  ...
  const client = useSelector(getClientDetailsSelector);
  ...
  useEffect(() => {
    setValidForm((prev) => ({
      ...
      billingAddress: true,
      mobileNo: !!clientForm?.mobileNo?.trim(),
      secmobileNo: true,
      vatNumber: true,
      openingBalance: true,
    }));
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    <div className="mt-2">
                      ...
                      <div className="bg-white rounded-xl mt-4">
                        ...
                        {clientForm.clientType === "Customer" ? (
                          <div className="flex mt-2">
                            <div className="flex-1">
                              <input
                                autoComplete="nope"
                                ...
                                onChange={(e) =>
                                  handlerClientValue(e, "secmobileNo")
                                }
                              />
                            </div>
                          </div>
                          ...
                          <div className="flex mt-2">
                            <div className="flex-1">
                              <input
                                ...
                                onChange={(e) =>
                                  handlerClientValue(e, "vatNumber")
                                }
                              />
                            </div>
                          </div>
                        ...
                        <div className="flex mt-2">
                          <div className="flex-1">
                            ...
                            disabled={true}
                              ...
                              onChange={(e) =>
                                handlerClientValue(e, "openingBalance")
                              }
                            />
                          </div>
                        </div>
